...
const MentorForgotPasswordPage = () => {
  ...
  const onSubmit = async (data: ForgotPasswordFormData) => {
    setIsLoading(true);
    try {
      await mentorService.forgotPassword({ email: data.email });
      setEmailSent(true);
        ...
        <div className="min-h-screen bg-black flex items-center justify-center py-12 px-4">
          <div className="w-full max-w-[420px] text-center">
            <div className="bg-[#1a1d26] border border-[#2a2d3a] rounded-2xl p-8">
              ...
              <p className="text-white font-semibold mb-6">{getValues('email')}</p>
              <p className="text-sm text-gray-500 mb-6">
                The link will expire in <span className="text-yellow-400 font-medium">15 minutes</span>. Check your spam folder if you don't see it.
              </p>
              <Link
                to="/mentor/login"
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5" noValidate>
              <div className="flex flex-col gap-1.5">
                <label className="text-white text-sm font-medium">
                  Mentor Email <span className="text-red-400">*</span>
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    } text-white placeholder-gray-500 focus:ring-0 focus:outline-none transition-all h-12 pl-12 pr-10`}
                  />
              ...
              <button
                type="submit"
                id="mentor-forgot-submit"
                disabled={isLoading}
                className="w-full h-12 rounded-lg bg-[var(--color-primary)] hover:bg-blue-600 text-white font-bold transition-all disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
                    <Spinner />
...
export default MentorForgotPasswordPage;