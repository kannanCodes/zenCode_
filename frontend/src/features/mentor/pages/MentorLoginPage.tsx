...
const MentorLoginPage = () => {
  ...
  // If already logged in, skip straight to mentor dashboard
  useEffect(() => {
  ...
  const onSubmit = async (data: LoginFormData) => {
    setIsLoading(true);
    try {
      const response = await mentorService.login(data);
        ...
        <div className="bg-[#1a1d26] border border-[#2a2d3a] rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">
              Access your ZenCode mentor environment.
            </p>
          </div>
